...
export function TypographyH1({
  ...
  return (
    <h1
      className={cn("scroll-m-20 text-2xl font-extrabold tracking-tight text-balance", className)}
      {...props}
    >
      {children}
    </h1>
...
export function TypographyH4({
  ...
  return (
    <h4
      className={cn("scroll-m-20 text-sm font-medium tracking-tight", className)}
      {...props}
    >
      {children}
    </h4>
